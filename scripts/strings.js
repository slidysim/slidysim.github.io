...
const totalWRsAmount = "WRs number";
...
const showAnyLevelRecords = "Show all records";
const showWRsOnly = "Show WRs only";
const showTopLabel = "Only including top";
const showPercentLabel = "Show records with kinch ≥";
